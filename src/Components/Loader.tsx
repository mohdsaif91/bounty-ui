...
function Loader() {
  return (
    ...
    >
      ...
      <g>
        <g className={style.pl__ring_rotate}>
          <circle
            className={style.pl__ring_stroke}
            cx="80"
            cy="80"
            r="72"
            fill="none"
      ...
      <g mask="url(#mask1)">
        <g className={style.pl__ring_rotate}>
          <circle
            className={style.pl__ring_strok}
            cx="80"
            cy="80"
            r="72"
            fill="none"
      ...
      <g>
        <g transform="translate(64,28)">
          <g className={style.pl__arrows} transform="rotate(45,16,52)">
            <path
              fill="hsl(3,90%,55%)"
